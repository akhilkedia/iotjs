...
options2 = {
  ...
  port: 443,
  highwatermark: 256,
  headers: {'Content-Length': 164, 'Content-Type': 'application/json',
...
var msgBody = '{"uid": "cb19e910d1cb441ba5a318ea88c3ac23",' +
  '"dtid": "dt6b12b870304e4dd5a88de2007f7d171e",' +
  '"name": "YourTes22","manifestVersion": -1,"manifestVersionPolicy": "LATEST"';
req2.write(msgBody);
req2.write('}');
//Note - END MUST BE CALLED!!!!!!
req2.end();
